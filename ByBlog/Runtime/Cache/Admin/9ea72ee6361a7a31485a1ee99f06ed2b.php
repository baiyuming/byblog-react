...
<div id="content" class="container">
    <form class="col s12 pt-60" method="post" action="/byblog/index.php/Admin/Blog/insert">
        <div class="row">
            <div class="col s9">
                <div class="row">
            ...
            <div class="col s3">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input id="a_time" name="a_time" type="text" class="validate">
